...
As described [earlier](01c_RNAseq_count_distribution.md), RNA-seq raw count data follows a Negative binomial distribution (Poisson-like), and the DESeq2 authors model the data as such. Modeling is a mathematically formalized way to approximate how the data behaves given a set of parameters (i.e. size factor, dispersion).
